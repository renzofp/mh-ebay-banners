...
function createTimeline(){
    ...
    /* ***** Start Coding Here ***** */
        ...
        tl.addLabel("frame1");
        tl.to(logoTop, {duration:0.6, autoAlpha:1, ease: "power4.out"}, "frame1-=0.6");
        tl.to(fullBlock1, {duration:0.8, y:"-100%", ease: "power4.out"}, "frame1");
        tl.to(fullBlock2, {duration:0.8, y:"-100%", ease: "power4.out"}, "frame1+=0.1");
        tl.to(fullBlock3, {duration:1, y:"-100%", ease: "power4.out"}, "frame1+=0.4");

        tl.to(frame1_text, {duration:1, stagger:1, autoAlpha:1, y:45, ease: "power3.out"}, "frame1+=0.6");
        ...
        tl.to([frame1_logo, frame1_cta, frame1_ctaArrow], {duration:0.8, stagger:0.1, autoAlpha:1, x:0, force3D:"true", ease: "power3.out"}, "frame2+=1.1");


        tl.addLabel("frame3", "+=2.2");
        tl.to(frame1_ctaArrow, {duration:0.25, scaleX:0.2, autoAlpha:0, x:-104, force3D:"true", ease: "power4.out"}, "frame3");
        tl.to(frame1_ctaArrow, {duration:0.6, scaleX:1, autoAlpha:1, x:0, force3D:"true", ease: "power4.out"}, "frame3+=0.4");
        
        tl.addLabel("frame4", "+=2.2");
        tl.to(frame1_ctaArrow, {duration:0.25, scaleX:0.2, autoAlpha:0, x:-104, force3D:"true", ease: "power4.out"}, "frame4");
        tl.to(frame1_ctaArrow, {duration:0.6, scaleX:1, autoAlpha:1, x:0, force3D:"true", ease: "power4.out"}, "frame4+=0.4");
        
        tl.addLabel("frame5", "+=2.2");
        tl.to(frame1_ctaArrow, {duration:0.25, scaleX:0.2, autoAlpha:0, x:-104, force3D:"true", ease: "power4.out"}, "frame5");
        tl.to(frame1_ctaArrow, {duration:0.6, scaleX:1, autoAlpha:1, x:0, force3D:"true", ease: "power4.out"}, "frame5+=0.4");
