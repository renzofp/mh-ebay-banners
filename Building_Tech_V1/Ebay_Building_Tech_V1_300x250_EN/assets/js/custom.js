...
function createTimeline(){
    ...
    tl.set(frame1_contentText, {scale:1.45, x:60, y:6});
    tl.set([frame1_text], {autoAlpha:0, y:-10});
    tl.set(frame1_blockText, {scaleX:1.27, scaleY:1.51});
    ...
    /* ***** Start Coding Here ***** */
        ...
        tl.to(frame1_ctaArrow, {duration:0.2, scaleX:0.2, autoAlpha:0, x:-42, ease: "power4.out"}, "frame3");
        tl.to(frame1_ctaArrow, {duration:0.5, scaleX:1, autoAlpha:1, x:0, ease: "power4.out"}, "frame3+=0.4");
        
        tl.addLabel("frame4", "+=2.2");
        tl.to(frame1_ctaArrow, {duration:0.2, scaleX:0.2, autoAlpha:0, x:-42, ease: "power4.out"}, "frame4");
        tl.to(frame1_ctaArrow, {duration:0.5, scaleX:1, autoAlpha:1, x:0, ease: "power4.out"}, "frame4+=0.4");
        
        tl.addLabel("frame5", "+=2.2");
        tl.to(frame1_ctaArrow, {duration:0.2, scaleX:0.2, autoAlpha:0, x:-42, ease: "power4.out"}, "frame5");
